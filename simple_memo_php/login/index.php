      ...
      <div class="card rounded login-card-width shadow">
        <div class="card-body">
          ...
          <div class="rounded-circle mx-auto border-gray border d-flex mt-3 icon-circle">
            <img class="w-75 mx-auto p-2" src="../public/images/animal_stand_zou.png" alt="icon">
          </div>
          ...
          <div class="row mt-3">
            <div class="offset-2 col-8 offset-2">
              ...
              <label class="input-group w-100">
                ...
                <input type="text" name="user_password" class="form-control" placeholder="パスワード" autocomplete="off" maxlength="255" />
              </label>
